...
public class CreatureWorld extends World
{
    ...
    public void act()
    {
        ...
        if ( turnNumber == 0){
            ...
            playerOneName = JOptionPane.showInputDialog(null,JOptionPane.QUESTION_MESSAGE);
            ...
            playerTwoName = JOptionPane.showInputDialog(null,JOptionPane.QUESTION_MESSAGE);
            ...
            oneFightMenu = new Menu(" Fight " ," Scratch \n Flamethorower ",24,Color.BLACK,Color.WHITE,Color.BLACK,Color.WHITE,new FightCommands());
        ...
        //TODO (22): Otherwise...
            ...
            showText(playerTwoName + ", it is your turn",getWidth()/2,getHeight()/2);
        }
        ...
        if( playerOneCreature.getHealthBar().getCurrent() <= 0 )
        {
            ...
            showText("Gary wins!!", getWidth()/2, getHeight()/2);
            Greenfoot.stop();
        }
        ...
        if( playerTwoCreature.getHealthBar().getCurrent() <= 0 )
        {
            ...
            showText("Ash wins!!", getWidth()/2, getHeight()/2);
            Greenfoot.stop();
        }
    }
     ...
     */
    /**
     * getTurnNumber returns the turn number which repersents what player is
     * supposed to attack
     * 
     * @param none there are no parameters
     * @return A int return type 
     */
     ...
     */
    /**
     * setTurnNumber sets the turnNumber variable to the turn parameter
     * 
     * @param A int Parameter ( that repersent's) turnNumber
     * @return nothing is returned
     */
