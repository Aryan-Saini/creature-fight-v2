...
public class Creature extends Actor
{
     ...
     * @param creatureType discusses what creatureType it is
     * @return an object of the Creature class
     */
     ...
     */
    /**
     * attack is a empty method that will get overridden in subclasses
     * 
     * @param a int parameter called idx (that repersents) if the player attacked
     * @return nothing is returned
     */
     ...
     */
    /**
     * getType returns teh type of player it is 
     * 
     * @param none there are no parameters
     * @return A String is returned (that repersents) the type of player
     */
